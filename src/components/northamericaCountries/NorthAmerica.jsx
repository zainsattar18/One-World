...
class NorthAmerica extends Component {
  ...
  async componentDidMount() {
    const country = await axios("https://cors-anywhere.herokuapp.com/http://countryapi.gear.host/v1/Country/getCountries?pRegion=Americas&pSubRegion=Northern%20America")
